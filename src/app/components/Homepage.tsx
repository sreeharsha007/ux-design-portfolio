    ...
    <div style={{ background: "#ffffff", color: "#1c1917", overflowX: "clip" }}>
      ...
      <section id="work" className="py-32 relative" style={{ background: "radial-gradient(ellipse at 80% -5%, rgba(196,82,42,0.055) 0%, transparent 52%), #ffffff" }}>
        <div className="max-w-[1200px] mx-auto px-6 lg:px-10 relative">
          ...
          {/* ── Secondary project(s) ──────────────────────────────────────────
              1 project  → same full-width featured-card layout as above (desktop + mobile)
              2+ projects → 2-col connected cluster (desktop) + swipe carousel (mobile)
              Adding more projects to data/projects.ts restores the grid automatically. */}

          {visibleSecondary.length === 1 ? (
            <>
              {/* ── Desktop: single project, featured-card layout ── */}
              <motion.div
              ...
              >
                <Link to={`/case-study/${visibleSecondary[0].id}`} className="block" style={{ textDecoration: "none", color: "inherit" }}>
                  {/* Image — same gradient + proportions as featured */}
                  <div className="relative overflow-hidden" style={{
                    ...
                    <div className="absolute bottom-0 inset-x-0" style={{ height: "90%" }}>
                      <motion.img
                        src={visibleSecondary[0].heroImage ?? "/Hero Image.png"}
                        alt={visibleSecondary[0].title}
                        initial={{ scale: 1.04, opacity: 0 }}
                        whileInView={{ scale: 1, opacity: 1 }}
                        viewport={{ once: true }}
                        transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1], delay: 0.2 }}
                  ...
                  {/* Content — same padding + 2-col structure as featured */}
                  <div className="p-6 lg:p-12">
                    <div className="flex flex-col lg:flex-row lg:gap-16 lg:items-start">
                      <div className="flex-1 min-w-0 lg:max-w-[48%]">
                        <div className="flex flex-wrap items-center gap-5 mb-5 text-[12px]">
                          <HighlightMark delay={0.2}>{visibleSecondary[0].category}</HighlightMark>
                          {visibleSecondary[0].clientSize && (<><span className="text-stone-400">·</span><HighlightMark delay={0.45}>{visibleSecondary[0].clientSize}</HighlightMark></>)}
                          {visibleSecondary[0].timeline && (<><span className="text-stone-400">·</span><HighlightMark delay={0.7}>{visibleSecondary[0].timeline}</HighlightMark></>)}
                        </div>
                        <h3
                          className="font-bold tracking-tight leading-tight"
                          style={{ fontSize: "clamp(1.5rem, 3vw, 2.4rem)", fontFamily: "var(--font-display)", color: "#1c1917" }}
                        >
                          {visibleSecondary[0].title}
                        </h3>
                      </div>
                      <div className="flex-1 mt-6 lg:mt-0 flex flex-col gap-7 justify-center">
                        <p className="text-base leading-relaxed text-stone-500">
                          {visibleSecondary[0].description}
                        </p>
                        <span
                          className="group inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold self-start transition-all duration-200"
                          style={{ background: "var(--terra-600)", color: "#ffffff" }}
                        >
                          Read Full Case Study
                          <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              ...
              {/* ── Mobile: single project, full-width card (no carousel) ── */}
              <div className="lg:hidden">
                <Link
                  to={`/case-study/${visibleSecondary[0].id}`}
                  className="flex flex-col rounded-2xl overflow-hidden"
                  style={{ background: "#ffffff", border: "1px solid #e7e5e4", boxShadow: "0 2px 12px rgba(0,0,0,0.05)", textDecoration: "none" }}
                >
                  <div className="relative overflow-hidden" style={{
                  ...
                  <div className="px-6 pt-6 pb-7 flex flex-col gap-5">
                    ...
                    <h3
                      className="text-[20px] font-bold tracking-tight leading-snug text-stone-900"
                    ...
                    <div className="flex items-center gap-1.5 self-start" style={{ color: "var(--terra-500)" }}>
          ...
          ) : visibleSecondary.length >= 2 ? (
            <>
              {/* ── Desktop: 2-col connected cluster ── */}
              <motion.div
                initial={{ opacity: 0, y: 24 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                  ...
                  {visibleSecondary.slice(0, 4).map((project, i) => (
                    ...
                    >
                      <div className="relative" style={{ height: "300px" }}>
                        ...
                        >
                          <img
                            ...
                            style={{ borderRadius: "10px 10px 0 0", filter: "drop-shadow(0 -6px 20px rgba(0,0,0,0.11))" }}
                          />
                        </motion.div>
                      </div>
                      <div className="px-10 pt-10 pb-12 flex flex-col gap-7 flex-1">
                        ...
                        <h3 className="text-[16px] font-bold tracking-tight leading-snug text-stone-900" style={{ fontFamily: "var(--font-display)" }}>
                          {project.title}
                        </h3>
                        <p className="text-[13px] line-clamp-2 leading-relaxed flex-1" style={{ color: "#78716c" }}>
                          {project.description}
                        </p>
                        <div className="flex items-center gap-1 transition-all group-hover:gap-2 self-start" style={{ color: "var(--terra-500)" }}>
                  ...
                  {visibleSecondary.slice(0, 4).map((project, i) => (
                    ...
                    >
                      <div className="relative" style={{ height: "clamp(200px, 48vw, 260px)" }}>
                        ...
                        >
                          <img
                            ...
                            alt={project.title}
                            className="w-full h-full object-cover object-top"
                            style={{ borderRadius: "10px 10px 0 0", filter: "drop-shadow(0 -4px 14px rgba(0,0,0,0.10))" }}
                          />
                        </motion.div>
                      </div>
                      <div className="px-6 pt-6 pb-7 flex flex-col gap-5 flex-1">
                        ...
                        <h3 className="text-[17px] font-bold tracking-tight leading-snug text-stone-900" style={{ fontFamily: "var(--font-display)" }}>
                          {project.title}
                        </h3>
                        <p className="text-[14px] line-clamp-3 leading-relaxed flex-1" style={{ color: "#78716c" }}>
                          {project.description}
                        </p>
                        <div className="flex items-center gap-1.5 self-start" style={{ color: "var(--terra-500)" }}>
                          <span className="text-[13px] font-medium">View case study</span>
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-10 relative">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
            ...
            >
              ...
              {/* CTAs — desktop only (mobile version lives below the Industries card) */}
              <div className="hidden lg:flex items-center gap-3 mt-10">
                <a
                  ...
                  className="group inline-flex items-center gap-2 px-6 py-3 rounded-xl text-[13px] font-semibold transition-all duration-200"
                  style={{ border: "1px solid rgba(217,119,6,0.35)", color: "var(--terra-500)", background: "rgba(217,119,6,0.04)" }}
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(217,119,6,0.55)"; (e.currentTarget as HTMLElement).style.background = "rgba(217,119,6,0.09)"; }}
                  onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(217,119,6,0.35)"; (e.currentTarget as HTMLElement).style.background = "rgba(217,119,6,0.04)"; }}
                >
                  Get in touch
                ...
                <a
                  ...
                  style={{ border: "1px solid #e7e5e4", color: "#57534e", background: "transparent" }}
            ...
            >
              ...
              {/* CTAs — mobile only (desktop version lives below the text in the left column) */}
      ...
      >
        <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2">
              <span
                className="text-[12px] font-semibold tracking-[0.08em] uppercase text-stone-600"
                style={{ fontFamily: "var(--font-display)" }}
              >
                Harsha Polepeddi
              </span>
            ...
            <div className="flex gap-6 text-[12px] text-stone-500">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 transition-colors duration-200 hover:text-stone-700"
              >
              ...
              <a
                href="https://linkedin.com/in/harshapolepeddi"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 transition-colors duration-200 hover:text-stone-700"
              >
                <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#0a66c2", flexShrink: 0 }}>
